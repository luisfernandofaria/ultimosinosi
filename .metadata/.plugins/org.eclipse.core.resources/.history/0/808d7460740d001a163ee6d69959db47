...
import com.lf.sino.exception.FileStorageException;
import com.lf.sino.exception.MyFileNotFoundException;
...
public class FileStorageService {
    ...
    public FileStorageService(FileStorageProperties fileStorageProperties) {
        ...
        try {
            ...
            throw new FileStorageException("Não foi possível criar o diretório para salvar os arquivos", ex);
        }
    }
    ...
    public String storeFile(MultipartFile file) {
        ...
        try {
            ...
            if(fileName.contains("..")) {
                throw new FileStorageException("Atenção! Aquivo com nome inválido! " + fileName);
            }
